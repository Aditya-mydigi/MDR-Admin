...
import { ChevronLeft, ChevronRight, LayoutDashboard, Users, Shield, Mail, CreditCard, LogOut } from "lucide-react";
...
export default function Sidebar({ sidebarOpen, collapsed = false, onToggleCollapse, onCloseMobile }: SidebarProps) {
                                ...
                                >
                                    ...
                                    {isActive && !collapsed && (
                                        <div className={clsx(
                                            ...
                                            item.label === "Billing Details" ? "bg-pink-600" : "bg-white"
                                        )} />
                                    )}
